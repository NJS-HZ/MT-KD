...
class AllCNN(nn.Module):
    def __init__(self, filters_percentage=1., n_channels=1, num_classes=11, dropout=False, batch_norm=True):
...
class ResNet9(nn.Module):
    def __init__(self, num_channels):
        ...
        self.fc = nn.Linear(in_features=256, out_features=11, bias=True)
